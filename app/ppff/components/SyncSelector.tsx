...
export function SyncSelector({ syncs, syncActivo, onSelect }: SyncSelectorProps) {
  ...
  return (
    <div className="flex flex-col gap-1.5 mt-2 p-1.5 rounded-lg bg-gray-50 border border-gray-200">
              ...
              >
                ...
                {isLatest && (
                  <span className={`text-[9px] px-1 py-0.5 rounded ${
                    isActive ? 'bg-emerald-900 text-emerald-200' : 'bg-gray-100 text-black'
                  }`}>
                    Última
                  </span>
                )}
